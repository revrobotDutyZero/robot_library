...
namespace robot_class {
    ...
    */
    void RobotCommand::initialize(){
        if(!initialized_){
            ...
            //Subscribers
            encoder_sub_ = nh.subscribe<gobot_msgs::EncodersMsg>("/encoders", 1, &RobotCommand::encodersCallback, this);
            speed_sub_ = nh.subscribe<gobot_msgs::MotorSpeedMsg>("/gobot_motor/motor_speed", 1, &RobotCommand::motorSpdCallback,this);
            battery_sub_ = nh.subscribe<gobot_msgs::BatteryMsg>("/gobot_base/battery_topic", 1, &RobotCommand::batteryCallback,this);
            ...
            sonar_sub_ = nh.subscribe<gobot_msgs::SonarMsg>("/gobot_base/sonar_topic", 1, &RobotCommand::sonarCallback,this);
            gyro_sub_ = nh.subscribe<gobot_msgs::GyroMsg>("/gobot_base/gyro_topic", 1, &RobotCommand::gyroCallback,this);
            ...
            weight_sub_ = nh.subscribe<gobot_msgs::WeightMsg>("/gobot_base/weight_topic", 1, &RobotCommand::weightCallback,this);
    ...
    */
    void RobotCommand::encodersCallback(const gobot_msgs::EncodersMsg::ConstPtr& msg){
    ...
    */
    ...
    void RobotCommand::motorSpdCallback(const gobot_msgs::MotorSpeedMsg::ConstPtr& speed){
    ...
    */
    void RobotCommand::batteryCallback(const gobot_msgs::BatteryMsg::ConstPtr& msg){
    ...
    */
    void RobotCommand::sonarCallback(const gobot_msgs::SonarMsg msg){
        sonar_data_ = msg;
    }
    ...
    */
    void RobotCommand::gyroCallback(const gobot_msgs::GyroMsg::ConstPtr& msg){
    ...
    */
    void RobotCommand::weightCallback(const gobot_msgs::WeightMsg::ConstPtr& msg){
    ...
    */
    bool RobotCommand::setTargetPath(const std::vector<Path> &path, std::string path_name){
        ...
        msg.request.data.push_back(""); //empty media path
    ...
    */
    void RobotCommand::getSonarData(std::vector<int> &data){
        data.clear();
        if (sonar_data_.distance.size() == 4)
        {
            data.push_back(sonar_data_.distance[0]);
            data.push_back(sonar_data_.distance[1]);
            data.push_back(sonar_data_.distance[2]);
            data.push_back(sonar_data_.distance[3]);
        }
    }
